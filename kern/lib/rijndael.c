...
struct rijndaelCtx *rijndael_set_key(struct rijndaelCtx *ctx,
				     const uint32_t *in_key,
...
void rijndael_encrypt(struct rijndaelCtx *ctx, const uint32_t *in_blk,
		      uint32_t *out_blk)
{
...
void rijndael_decrypt(struct rijndaelCtx *ctx, const uint32_t *in_blk,
		      uint32_t *out_blk)
{
	uint32_t b0[4], b1[4], *kp;
	uint32_t k_len = ctx->k_len;
...
void aes_set_key(struct rijndaelCtx *ctx, const uint8_t *key, unsigned keybits,
		 int enc)
{
	uint32_t *k;
...
void aes_ecb_encrypt(struct rijndaelCtx *ctx, uint8_t *data, unsigned len)
{
	unsigned bs = 16;
	uint32_t *d;
...
void aes_ecb_decrypt(struct rijndaelCtx *ctx, uint8_t *data, unsigned len)
{
	unsigned bs = 16;
	uint32_t *d;
...
void aes_cbc_encrypt(struct rijndaelCtx *ctx, uint8_t *iva, uint8_t *data,
		     unsigned len)
{
...
void aes_cbc_decrypt(struct rijndaelCtx *ctx, uint8_t *iva, uint8_t *data,
		     unsigned len)
{
	uint32_t *d = (uint32_t *)data;
	unsigned bs = 16;
